...
def getRegularizationValues():
    ...
    """
    values = np.ndarray.tolist(np.random.uniform(0,.03,100))

    # my vectors: 
    # Best regularization value: 3.33E-03
    # Test accuracy (%): 30.045249  
    
    # pretrained
    # Best regularization value: 1.6E-02
...
def chooseBestModel(results):
    ...
    # DIRECTLY TAKEN FROM THE OFFICIAL SOLUTION SHEET
    bestResult = bestResult = max(results, key=lambda x:  x["dev"])
