...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.dropout_placeholder = tf.placeholder(tf.float32,shape = ()) # or should shape be []?
        ### END YOUR CODE
    ...
    def add_embedding(self):
        ...
        #very IMPORTANT to have this as a VARIABLE, not to just copy it      
        
        index_tensor = tf.nn.embedding_lookup(embedding_tensor,self.input_placeholder)             
        embeddings = tf.reshape(index_tensor,(-1,self.config.n_features * self.config.embed_size))
        ### END YOUR CODE
        return embeddings
